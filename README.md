# Adobe Commerce Frontend Core

This repository is used to store the code for the [Commerce Frontend Development documentation](https://developer.adobe.com/commerce/frontend-core/) website. It is built using the [Adobe Edge Delivery Services](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/overview) and deployed to [Adobe Developer](https://developer.adobe.com/commerce/frontend-core/).

This site contains the latest Adobe Commerce and Magento Open Source frontend development documentation, including guides for themes, layouts, templates, CSS, JavaScript, UI components, and Page Builder.
