...
The list widget is deprecated since version 2.2.0. As an alternative component for the admin area, use [DynamicRows](../../ui-components/components/dynamic-rows.md).
