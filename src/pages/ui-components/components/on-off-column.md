...
| `fieldClass` | Additional CSS classes added to the column's field elements. | `{[name: string]: boolean}` | `{'admin__scope-old': true, 'data-grid-onoff-cell': true, 'data-grid-checkbox-cell': false}` |
