...
This topic describes how to extend the existing [`UrlInput` component](../components/url-input.md) to implement a new link type, or update an existing one, for your module.
