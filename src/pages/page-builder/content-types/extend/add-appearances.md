...
![Steps for adding appearances](../../../_images/page-builder/how-to-add-appearance.svg)
...
![Visual selector for Banner](../../../_images/page-builder/banner-visual-selector.png)
...
![File and location for the VisualSelect class](../../../_images/page-builder/add-visualselect-class.png)

Within the `di.xml` file, add a virtual type using the`VisualSelect` class with the Banner's virtual type name (`<virtualType name="AppearanceSourceBanner"`).
...
To add more appearance options, simply create more `item` arrays with names that match the `value`.
...
![Appearance icons for Banner](../../../_images/page-builder/appearance-icon-location.png)
...
![Appearance configurations explained](../../../_images/page-builder/appearance-configurations.png)
...
![Add appearances to Banner content type](../../../_images/page-builder/appearance-config-file.png)
...
![Banner appearance templates](../../../_images/page-builder/appearance-templates-banner.png)
...
![Add additional templates to template/content-type/$content-type-name/$appearance-name](../../../_images/page-builder/appearance-templates-additional.png)
...
![Banner stylesheets](../../../_images/page-builder/appearance-css-banner.png)
...
![Add additional stylesheets to css/source/content-type/[content-type-name]/](../../../_images/page-builder/appearance-css-additional.png)
